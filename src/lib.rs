#![feature(int_roundings, new_uninit, unwrap_infallible, vec_into_raw_parts, const_trait_impl, slice_flatten, box_into_inner, allocator_api, maybe_uninit_slice, anonymous_lifetime_in_impl_trait, array_chunks, pointer_byte_offsets, let_chains)]
