...
impl<'a, T> RefUnwindSafe for InOutPtr<'a, T> {}
impl<'a, T> UnwindSafe for InOutPtr<'a, T> {}
...
pub(super) trait ReadPtr<'a, T> {
	...
	fn aliases<'b, U>(&self, rhs: &impl ReadPtr<'b, U>) -> bool {
		core::ptr::addr_eq(self.ptr(), rhs.ptr())
	}
...
/// Wraps some function for C FFI (catches panics)
#[track_caller]
